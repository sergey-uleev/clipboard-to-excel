...
def validate(str):
    return re.search(re_pkpvd, str) or re.search(re_pkpvdmfc, str) or re.search(re_ofsite, str) or re.search(re_other, str) or re.search(re_vedomstvo, str) or re.search(re_bc, str)